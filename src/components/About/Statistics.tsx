...
export const Statistics = () => {
  return (
    <div
      className={`justify-evenly mt-35 mb-0 flex h-[20vh] sm:h-[65vh] w-screen shrink-0 place-items-center bg-[url(@/assets/about/unsplash_okVXy9tG3KY.png)] bg-contain bg-no-repeat lg:mt-25 lg:h-150 lg:justify-evenly lg:gap-20`}
    >
